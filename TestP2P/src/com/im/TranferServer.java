...
public class TranferServer extends Thread
{
	...
	private int port =IConstant.PORT_SERVER_DEFAULT ;

	public TranferServer(ISocketOberser iSocketOberser,
	        IFileTransObserver fileTransObserver ,int port)
	{
		super();
	...
	public void run()
	{
		try
		{
			...
			iSocketOberser.notifyDescript("begin bind port:" + this.port);
			...
			iSocketOberser.notifyDescript("listener port : " + this.port + " success.");
